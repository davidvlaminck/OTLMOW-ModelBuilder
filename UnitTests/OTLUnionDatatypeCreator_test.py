...
expectedDtu = ['# coding=utf-8',
               ...
               '        """Kwantitatieve waarde van het test Union filename"""',
               ...
               '        """Vrij tekstveld van het test Union filename"""',
               ...
               '    """Union filename voor test doeleinden."""',
               ...
               "    definition = 'Union filename voor test doeleinden.'",
