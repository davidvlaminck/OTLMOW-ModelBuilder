...
expectedKwantWrd = ['# coding=utf-8',
                    ...
                    "                                              definition='De standaard eenheid bij dit filename is uitgedrukt in percent.',",
                    '                                              owner=self)',
                    '',
                    ...
                    "                                    definition='Bevat een getal die bij het filename hoort.',",
                    '                                    owner=self)',
                    '',
                    '    @property',
                    '    def standaardEenheid(self) -> str:',
                    '        """De standaard eenheid bij dit filename is uitgedrukt in percent."""',
                    '        return self._standaardEenheid.usagenote.split(\'"\')[1]',
                    '',
                    '    @property',
                    '    def waarde(self) -> float:',
                    '        """Bevat een getal die bij het filename hoort."""',
...
expectedDte = ['# coding=utf-8',
               ...
               "test filename voorstelt.',",
               '                                    owner=self)',
               '',
               '    @property',
               '    def waarde(self) -> str:',
               '        """De string die het eenvoudige test filename voorstelt."""',
               '        return self._waarde.get_waarde()',
               '',
               '    @waarde.setter',
               '    def waarde(self, value):',
