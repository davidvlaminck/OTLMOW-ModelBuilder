...
class KlSterkteklasseHout(KeuzelijstField):
    ...
    options = {
        'c14': KeuzelijstWaarde(invulwaarde='c14',
                                label='C14',
                                status='ingebruik',
                                definitie='C staat voor naaldhout. 14 N/mmÃ‚Â² (megaPascal) drukt de buigsterkte uit evenwijdig aan de vezel.',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlSterkteklasseHout/c14'),
        'c16': KeuzelijstWaarde(invulwaarde='c16',
                                label='C16',
                                status='ingebruik',
                                definitie='C staat voor naaldhout. 16 N/mmÃ‚Â² (megaPascal) drukt de buigsterkte uit evenwijdig aan de vezel.',
