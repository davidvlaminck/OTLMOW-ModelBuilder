...
class KlBetonomgevingsklasse(KeuzelijstField):
    ...
    options = {
        ...
        'e0': KeuzelijstWaarde(invulwaarde='e0',
                               label='E0',
                               status='ingebruik',
                               objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e0'),
        'ea1': KeuzelijstWaarde(invulwaarde='ea1',
                                label='EA1',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/ea1'),
        'ea2': KeuzelijstWaarde(invulwaarde='ea2',
                                label='EA2',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/ea2'),
        'ea3': KeuzelijstWaarde(invulwaarde='ea3',
                                label='EA3',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/ea3'),
        'ee1': KeuzelijstWaarde(invulwaarde='ee1',
                                label='EE1',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/ee1'),
        'ee2': KeuzelijstWaarde(invulwaarde='ee2',
                                label='EE2',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/ee2'),
        'ee3': KeuzelijstWaarde(invulwaarde='ee3',
                                label='EE3',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/ee3'),
        'ee4': KeuzelijstWaarde(invulwaarde='ee4',
                                label='EE4',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/ee4'),
        'ei': KeuzelijstWaarde(invulwaarde='ei',
                               label='EI',
                               status='ingebruik',
                               objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/ei'),
        'es1': KeuzelijstWaarde(invulwaarde='es1',
                                label='ES1',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/es1'),
        'es2': KeuzelijstWaarde(invulwaarde='es2',
                                label='ES2',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/es2'),
        'es3': KeuzelijstWaarde(invulwaarde='es3',
                                label='ES3',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/es3'),
        'es4': KeuzelijstWaarde(invulwaarde='es4',
                                label='ES4',
                                status='ingebruik',
                                objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/es4'),
