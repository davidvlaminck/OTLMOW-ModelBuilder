...
class KlWetenschappelijkeSoortnaam(KeuzelijstField):
    ...
    options = {
        ...
        'wetenschappelijkenaam.naam': KeuzelijstWaarde(invulwaarde='wetenschappelijkenaam.naam',
                                                       label='wetenschappelijkeNaam.naam',
                                                       status='ingebruik',
                                                       objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlWetenschappelijkeSoortnaam/wetenschappelijkenaam.naam'),
