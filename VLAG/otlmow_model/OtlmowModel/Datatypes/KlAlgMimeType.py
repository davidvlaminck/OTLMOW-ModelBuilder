...
class KlAlgMimeType(KeuzelijstField):
    ...
    options = {
        ...
        'image-heic': KeuzelijstWaarde(invulwaarde='image-heic',
                                       label='image/heic',
                                       status='verwijderd',
                                       definitie='image/heic',
                                       objectUri='https://wegenenverkeer.data.vlaanderen.be/id/concept/KlAlgMimeType/image-heic'),
