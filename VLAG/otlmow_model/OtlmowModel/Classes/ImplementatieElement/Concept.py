...
class Concept(AIMLinkObject):
    ...
    def __init__(self):
        ...
        self.add_valid_relation(relation='https://wegenenverkeer.data.vlaanderen.be/ns/onderdeel#BehoortTot', target='https://www.w3.org/2004/02/skos/core#ConceptScheme', direction='u')  # u = unidirectional
